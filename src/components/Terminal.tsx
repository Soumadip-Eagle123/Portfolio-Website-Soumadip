...
export const commands: Command = [
  { cmd: "about", desc: "about Soumadip Sen", tab: 8 },
  { cmd: "clear", desc: "clear the terminal", tab: 8 },
  { cmd: "echo", desc: "print out anything", tab: 9 },
  { cmd: "education", desc: "academic details", tab: 8 },
  { cmd: "email", desc: "send an email to me", tab: 8 },
  { cmd: "gui", desc: "open GitHub profile", tab: 10 },
  { cmd: "help", desc: "check available commands", tab: 9 },
  { cmd: "history", desc: "view command history", tab: 6 },
  { cmd: "projects", desc: "view my GitHub projects", tab: 5 },
  { cmd: "pwd", desc: "print current working directory", tab: 10 },
  { cmd: "socials", desc: "check social profiles", tab: 6 },
